...
class AocDay24 : public AocDay
{
    private:
        ...
        bool find_best_partition_3(long * input, int input_size, int output_size, long target, long * best_values, long & best_qr);
        bool find_best_partition_4(long * input, int input_size, int output_size, long target, long * best_values, long & best_qr);
    public:
        AocDay24();
        ~AocDay24();
